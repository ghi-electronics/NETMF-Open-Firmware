...
#include "GHIElectronics_OSH_NETMF_Hardware_GHIElectronics_OSH_NETMF_Hardware_SoftwareI2CBus.h"
...
INT8 SoftwareI2CBus::NativeI2CWriteRead( INT32 clockPin, INT32 dataPin, INT32 clockRateKhz, UINT16 address, CLR_RT_TypedArray_UINT8 writeBuffer, INT32 writeOffset, INT32 writeLength, CLR_RT_TypedArray_UINT8 readBuffer, INT32 readOffset, INT32 readLength, INT32 * numWritten, INT32 * numRead, HRESULT &hr )
{
	...
	GHI_OSH_HAL_SoftwareI2C i2c;
	i2c.scl = clockPin;
	i2c.sda = dataPin;
	i2c.clockSpeed = clockRateKhz;
	i2c.address = address;

	return GHI_OSH_HAL_SoftwareI2C_WriteRead(&i2c, writeBuffer.GetBuffer() + writeOffset, writeLength, readBuffer.GetBuffer() + readOffset, readLength, (UINT32*)numWritten, (UINT32*)numRead);
}
