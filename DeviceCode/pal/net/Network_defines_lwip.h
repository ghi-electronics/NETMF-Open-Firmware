...
/* TCP receive window. */
#define TCP_WND__min                        (2*TCP_MSS__min)
#define TCP_WND__default                    (2*TCP_MSS__default)
#define TCP_WND__max                        (2*TCP_MSS__max)
