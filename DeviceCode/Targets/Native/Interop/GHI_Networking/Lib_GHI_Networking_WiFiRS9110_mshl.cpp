...
HRESULT Library_Lib_GHI_Networking_WiFiRS9110::NativeGetInternalMacAddress___VOID__SZARRAY_U1( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
        ...
        WiFiRS9110::NativeGetInternalMacAddress( pMngObj,  param0, hr );
        TINYCLR_CHECK_HRESULT( hr );
    }
    TINYCLR_NOCLEANUP();
}
