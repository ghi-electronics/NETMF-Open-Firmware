...
HRESULT Library_Lib_GHI_Processor_DebugInterface::NativeLoad___STATIC__VOID__BYREF_I4__BYREF_I4__BYREF_BOOLEAN( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        ...
        DebugInterface::NativeLoad( param0, param1, param2, hr );
...
HRESULT Library_Lib_GHI_Processor_DebugInterface::NativeSave___STATIC__BOOLEAN__I4__I4__BOOLEAN( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        INT32 param0;
        ...
        INT8 retVal = DebugInterface::NativeSave( param0, param1, param2, hr );
        TINYCLR_CHECK_HRESULT( hr );
