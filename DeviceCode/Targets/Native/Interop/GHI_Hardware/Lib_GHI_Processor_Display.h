...
namespace GHI
{
    namespace Processor
    {
        struct Display
        {
            ...
            static INT8 NativeSetSpiConfiguration( INT32 param0, INT32 param1, INT32 param2, INT32 param3, INT32 param4, INT32 param5, INT32 param6, INT32 param7, INT8 param8, INT32 param9, INT32 param10, INT8 param11, INT8 param12, INT32 param13, INT32 param14, HRESULT &hr );
