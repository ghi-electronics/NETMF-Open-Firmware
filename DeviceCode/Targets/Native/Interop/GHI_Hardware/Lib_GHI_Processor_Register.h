...
#ifndef _LIB_GHI_PROCESSOR_REGISTER_H_
#define _LIB_GHI_PROCESSOR_REGISTER_H_
...
namespace GHI
{
    namespace Processor
    {
        struct Register
        {
            ...
            static UINT32& Get_address( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_UINT32( pMngObj, Library_Lib_GHI_Processor_Register::FIELD__address ); }
...
#endif  //_LIB_GHI_PROCESSOR_REGISTER_H_
