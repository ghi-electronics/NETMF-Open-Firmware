...
HRESULT Library_HAL_GHI_OSHW_Hardware_Util::SetSpecialDisplayConfig___STATIC__BOOLEAN__I4__I4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        INT32 param0;
        ...
        INT8 retVal = Util::SetSpecialDisplayConfig( param0, param1, hr );
        TINYCLR_CHECK_HRESULT( hr );
