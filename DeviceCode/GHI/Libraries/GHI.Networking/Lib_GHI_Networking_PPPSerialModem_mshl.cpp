...
HRESULT Library_Lib_GHI_Networking_PPPSerialModem::NativeConnect___I4__U4__STRING__STRING__U4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
        ...
        INT32 retVal = PPPSerialModem::NativeConnect( pMngObj,  param0, param1, param2, param3, hr );
        TINYCLR_CHECK_HRESULT( hr );
