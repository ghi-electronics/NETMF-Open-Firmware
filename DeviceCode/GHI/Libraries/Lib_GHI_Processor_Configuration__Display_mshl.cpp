...
HRESULT Library_Lib_GHI_Processor_Configuration__Display::NativeSetParallelConfiguration___STATIC__BOOLEAN__I4__I4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        INT32 param0;
        ...
        INT8 retVal = Configuration_Display::NativeSetParallelConfiguration( param0, param1, hr );
        TINYCLR_CHECK_HRESULT( hr );
        SetResult_INT8( stack, retVal );
