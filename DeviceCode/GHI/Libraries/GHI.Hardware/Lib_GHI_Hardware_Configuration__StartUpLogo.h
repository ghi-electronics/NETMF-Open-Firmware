...
#ifndef _LIB_GHI_HARDWARE_CONFIGURATION__STARTUPLOGO_H_
#define _LIB_GHI_HARDWARE_CONFIGURATION__STARTUPLOGO_H_
...
#endif  //_LIB_GHI_HARDWARE_CONFIGURATION__STARTUPLOGO_H_
