...
bool WaitForTinyBooterUpload( INT32 &timeout_ms )
{
    ...
    if( CPU_GPIO_EnableInputPin((96 + 7), FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLUP)) //(96 + 7) = PD7 Pin3 on Socket 14
    {
...
BOOL TinyBooter_GetReleaseInfo(MfReleaseInfo& releaseInfo)
{
    MfReleaseInfo::Init(
                    releaseInfo, 
                    VERSION_MAJOR, VERSION_MINOR, GHI_VERSION_BUILD/*VERSION_BUILD*/, GHI_VERSION_REVISION/*VERSION_REVISION*/, 
