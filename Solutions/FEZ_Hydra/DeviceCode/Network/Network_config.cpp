...
NETWORK_CONFIG g_NetworkConfig =
{
    ...
    {       // ENC28J60 chip
        {                                      
            0,//SOCK_NETWORKCONFIGURATION_FLAGS_DHCP | SOCK_NETWORKCONFIGURATION_FLAGS_TYPE__set(SOCK_NETWORKCONFIGURATION_FLAGS_WIRELESS),
            SOCK_MAKE_IP_ADDR_LITTLEEND(192, 168,  5, 100),
			//SOCK_MAKE_IP_ADDR_LITTLEEND(192,168,  1,235),
            SOCK_MAKE_IP_ADDR_LITTLEEND(255,255,255,  0),
			SOCK_MAKE_IP_ADDR_LITTLEEND(0, 0,  0,  0),
            //SOCK_MAKE_IP_ADDR_LITTLEEND(192,168,  1,  1), 
            SOCK_MAKE_IP_ADDR_LITTLEEND(  0,  0,  0,  0), 
            SOCK_MAKE_IP_ADDR_LITTLEEND(  0,  0,  0,  0), 
