...
FileSystemVolume g_USBiziOpen_FS;

void FS_AddVolumes()
{
    //FileSystemVolumeList::AddVolume( &g_USBiziOpen_FS, "ROOT", 0, 0, &g_FAT32_STREAM_DriverInterface, &g_FAT32_FILE_SYSTEM_DriverInterface, &g_SST39VF320_16_BS, 0, FALSE );
}
