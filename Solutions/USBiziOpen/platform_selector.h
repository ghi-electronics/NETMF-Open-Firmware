...
#ifndef _PLATFORM_USBiziOpen_SELECTOR_H_
#define _PLATFORM_USBiziOpen_SELECTOR_H_ 1


#if defined(PLATFORM_ARM_USBiziOpen)
#define HAL_SYSTEM_NAME                             "USBiziOpen"
#define PLATFORM_ARM_LPC24XX                        1

#if !defined(HAL_REDUCESIZE)
//#define USBiziOpen_SOCKETS_ENABLED                  1
#endif

#define TINYCLR_TRACE_EXCEPTIONS // To show Exceptions?
#define TINYCLR_TRACE_ERRORS // To show errors?
//#define TINYCLR_GC_VERBOSE // To Show Garbage Collector
//#define TINYCLR_TRACE_INSTRUCTIONS // To show ??

#define PLATFORM_ARM_USBiziOpen
...
//external SDRAM, 32MB
#define SRAM1_MEMORY_Base   0x40000000
...
#endif // PLATFORM_ARM_USBiziOpen


#endif // _PLATFORM_USBiziOpen_SELECTOR_H_ 1
